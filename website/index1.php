...
<head>
  ...
  <link rel="accountpage" href="accountpage.html" type="text/html">
	...
	<link rel="ticketsell" href="ticketsell.html" type="text/html">
  ...
  <title>Tickify</title>
	...
	<nav class="nav">
      <div class="logo">
          <a href="index.html"><img src="image/Unbenannt-3-[Wiederhergestellt].png"  /></a>
    ...
    <div class="container-fluid" style="height: 100%; overflow: hidden">
      ...
      <div class="row center" style="width: 100%">
        <div class="col-12 text-white text-center">
          <h1 class="scaling-font" style="overflow:hidden">lol!</h1>
        </div>
...
<footer>
 <div class="footerlogo">
  ...
  <div class="Impressum">
    <p style="font-size:15px;">Imprint</p> 
  </div class="Impressum">
  <div class="Account">
    <p style="font-size:15px;">My Account</p> 
  </div class="Account">
  <div class="Warenkorb">
    <p style="font-size:15px;">My Cart</p> 
  </div class="Warenkorb">
  <div class="AboutUs">
    <p style="font-size:15px;">About Us</p> 
  </div class="AboutUs">
  <div class="Help">
    <p style="font-size:15px;">Need Help?</p> 
  </div class="Help">
